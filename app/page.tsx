...
export default function Home() {
  return (
    <div className='min-h-[calc(100vh-64px-30px)] w-full flex flex-col gap-4'>
      <div className='w-full grid grid-cols-[1fr] lg:grid-cols-[3fr_1fr]'>
        <div className='w-full relative  lg:h-162.5 h-100 overflow-hidden border-2 '>
          ...
          <div className='absolute bottom-12 md:left-12 left-4 flex flex-col w-[90%] gap-4 z-10'>
            ...
            <p className="md:text-lg text-white text-sm md:w-125 w-75  font-bold font-['Space_Grotesk']">
              In a world where memories are traded like currency, one thief
              risks everything to recover the only dream that was never for
              sale.
            </p>
        ...
        <div className='w-full md:overflow-y-auto no-scrollbar md:h-150 p-4'>
          ...
          <div className='w-full flex flex-col gap-4 mt-4'>
            ...
            <Card className='w-full text-white'>
              ...
              <CardContent>
                <CardDescription>
                  Discover curated collections from world-renowned directors
                  every Monday.
                </CardDescription>
              </CardContent>
              <CardFooter>
