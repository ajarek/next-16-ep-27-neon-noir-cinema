      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row justify-between gap-12 lg:gap-8">
        ...
        <div className="flex flex-col gap-4 max-w-sm">
          ...
          <p className="text-muted-foreground text-sm xl:text-base leading-relaxed">
            The ultimate destination for the connoisseur of atmosphere, light, and indie cinema. Curating the dark since 2024.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-2 gap-12 lg:gap-24">
          ...
          <div className="flex flex-col gap-3">
            <h3 className="font-bold text-foreground mb-2 tracking-wider text-sm uppercase">Platform</h3>
          ...
          <div className="flex flex-col gap-3">
            <h3 className="font-bold text-foreground mb-2 tracking-wider text-sm uppercase">Support</h3>
            <Link href="#" className="text-muted-foreground hover:text-primary transition-colors text-sm">
              Help Center
            </Link>
            <Link href="#" className="text-muted-foreground hover:text-primary transition-colors text-sm">
        ...
        <div className="flex flex-col gap-4 w-full md:w-auto">
          <h3 className="font-bold text-foreground mb-2 tracking-wider text-sm uppercase">Newsletter</h3>
          ...
          <div className="flex gap-3 mt-2">
            <Button variant="outline" size="icon" className="rounded-full w-10 h-10 bg-card/60 border-transparent hover:bg-card/80 text-muted-foreground transition-all hover:text-foreground">
              <Share2 className="w-4 h-4" />
            </Button>
            <Button variant="outline" size="icon" className="rounded-full w-10 h-10 bg-card/60 border-transparent hover:bg-card/80 text-muted-foreground transition-all hover:text-foreground hover:scale-105">
